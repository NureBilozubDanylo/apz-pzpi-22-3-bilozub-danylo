...
@router.post("/update_sensors")
async def update_multiple_sensor_values(request: Request, db: Session = Depends(get_db)):
    ...
    for sensor_data in data:
        ...
        db_sensor.current_value = value
        db_sensor.last_maintenance = datetime.now()
        db.commit()
        db.refresh(db_sensor)
        ...
        updated_sensors.append(db_sensor)
    
    return "Sensors updated successfully"
